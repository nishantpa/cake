...
# Write a function that returns a list of all the duplicate files. We'll check them by hand 
# before actually deleting them, since programmatically deleting files is really scary. 
